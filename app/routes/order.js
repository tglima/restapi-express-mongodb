...
router.get('/find/customer/nuDocument=:nuDocument', jwtService.verifyJWT, findByNuDocument);
router.get('/find/customer/idCustomer=:idCustomer', jwtService.verifyJWT, findByIdCustomer);
